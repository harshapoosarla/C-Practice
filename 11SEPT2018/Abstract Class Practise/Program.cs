   ...
   public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Salary:\t\t"+Staff1.DisplaySalary());
            Console.WriteLine("\n");
            ...
            Console.WriteLine("Manager Salary:\t"+Manager1.DisplaySalary());
            ...
            Console.WriteLine("Salesman Salary:\t"+Salesman1.DisplaySalary());
